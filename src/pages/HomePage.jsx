...
const HomePage = () => {
  ...
  const socialLinks = {
    ...
    email: "mailto:soft_mks@gmx.es",
    cv: "https://asset.cloudinary.com/dnwyfbj7m/4270d9ec463ecc18aa07f0c4601edadd",
  };
  ...
  return (
    <div className="page-container bg-animated-gradient overflow-hidden">
      <div className="absolute inset-0 opacity-10">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-1/2 w-80 h-80 bg-accent-cyan rounded-full filter blur-3xl animate-pulse-slow"
      ...
      <div className="content-wrapper">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div
            className="lg:col-span-8 space-y-6 animate-fadeInUp"
