        ...
        <div className="bg-black text-gray-300">
            <div className="flex flex-col lg:flex-row items-center lg:items-start px-4 lg:pl-80 mt-6 mb-8 space-y-8 lg:space-y-0">
                <div className="lg:w-2/3 animate__animated animate__fadeInLeft">
                    <Letters value={t('studies.title3')} size="xl" underline={false} gradient={true} className="text-left text-white mb-2" id="title" />
                    <Letters value={t('studies.date3')} size="s" underline={false} gradient={true} className="text-left text-white mb-2" id="date" />
                    <Letters value={t('studies.description3')} size="m" underline={false} gradient={true} className="text-left text-white mt-8" id="description" />
                </div>
                <div className="lg:w-1/3 lg:pl-8 mt-4 lg:mt-0 flex justify-center animate__animated animate__fadeInRight">
                    <img src={t('studies.image2')} alt="imagen campus 42" className="w-72 h-auto mb-8 mx-auto mt-8 lg:mx-0 rounded-lg border-[6px] border-gray-200 transition-transform transform hover:scale-105 hover:shadow-xl" />
                </div>
            </div>
            ...
            <div className="px-4 lg:pl-80 mt-6 mb-8">
                ...
                <img src={t('studies.image1')} alt="certificado" className="w-72 h-auto mb-8 mx-auto mt-4 rounded-lg border-[6px] border-gray-200 transition-transform transform hover:scale-105 hover:shadow-xl" />
            ...
            <div className="px-4 lg:pl-80 mt-6 mb-8">
                ...
                <img src={t('studies.image')} alt="Foto de perfil" className="w-72 h-auto mb-8 mx-auto mt-4 rounded-lg border-[6px] border-gray-200 transition-transform transform hover:scale-105 hover:shadow-xl"/>
