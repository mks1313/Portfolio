  ...
  return (
    <div className="page-container">
      ...
      <div className="mb-16 text-center">
        <h1 className="text-5xl md:text-6xl font-black bg-linear-to-r from-cyan-400 via-purple-500 to-pink-600 bg-clip-text text-transparent mb-4">
          {t("navbar.studies")}
        </h1>
        <p className="text-gray-400 text-lg max-w-2xl mx-auto">
          {t("studies.pageSubtitle")}
        </p>
        <div className="h-1 w-24 bg-linear-to-r from-cyan-500 to-purple-500 rounded-full mx-auto mt-6"></div>
      </div>

      {/* Timeline vertical */}
      <div className="max-w-6xl mx-auto relative">
        {/* Línea vertical central */}
        <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-0.5 bg-linear-to-b from-cyan-500/50 via-purple-500/50 to-pink-500/50 transform -translate-x-1/2"></div>
        ...
        {studyData.length > 0 && (
          <div className="mt-16 text-center">
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-linear-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/30 rounded-full">
