...
const StudiesPage = () => {
    ...
    return (
        <div className="bg-black text-gray-300">
            <div className="flex flex-col lg:flex-row items-center lg:items-start px-4 lg:pl-80 mt-6 mb-8">
                ...
                <div className="lg:w-1/3 lg:pl-8 mt-4 lg:mt-0 flex justify-center">
                    <img src={t('studies.image2')} alt="imagen campus 42" className="w-72 h-auto mb-8 mx-auto mt-8 lg:mx-0 rounded-lg border-[6px] border-gray-200" />
                </div>
            </div>
            ...
            <div className="px-4 lg:pl-80 mt-6 mb-8">
                ...
                <img src={t('studies.image1')} alt="certificado" className="w-72 h-auto mb-8 mx-auto mt-4 rounded-lg border-[6px] border-gray-200"/>
            ...
            <div className="px-4 lg:pl-80 mt-6 mb-8">
                ...
                <img src={t('studies.image')} alt="Foto de perfil" className="w-72 h-auto mb-8 mx-auto mt-4 rounded-lg border-[6px] border-gray-200"/>
